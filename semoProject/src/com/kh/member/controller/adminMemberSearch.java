...
public class adminMemberSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 수
		listCount = new MemberService().getSearchListCount(name);
		...
		ArrayList<Member> list = new MemberService().searchMember(pi, name);
		...
		if(list != null) {
			...
			request.getRequestDispatcher("views/admin/member/adminMemberList.jsp").forward(request, response);
		} else {
			request.setAttribute("msg", "회원 검색 오류");
