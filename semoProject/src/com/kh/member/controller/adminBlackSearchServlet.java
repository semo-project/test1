...
/**
 * Servlet implementation class adminBlackSearchServlet
 */
@WebServlet("/blackSearch.me")
public class adminBlackSearchServlet extends HttpServlet {
     ...
     */
    public adminBlackSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 수
		listCount = new MemberService().getBlackSearchCount(search);
		...
		ArrayList<Member> list = new MemberService().selectBlackSearch(pi, search);
		
		if(list != null) {
			request.setAttribute("list", list);
			request.setAttribute("pi", pi);
			request.setAttribute("search", search);
			request.getRequestDispatcher("views/admin/member/adminBlackList.jsp").forward(request, response);			
		} else {
