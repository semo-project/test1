...
/**
 * Servlet implementation class adminWriterSearchServlet
 */
@WebServlet("/writerSearch.wr")
public class adminWriterSearchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminWriterSearchServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 수
		listCount = new WriterService().getSearchListCount(search);
		...
		ArrayList<Writer> list = new WriterService().selectSearchWriter(pi, search);
