...
/**
 * Servlet implementation class adminReportCommentServlet
 */
@WebServlet("/comment.re")
public class adminReportCommentServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminReportCommentServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 총 게시글 수
		listCount = new ReportService().getListCommentCount();
		...
		ArrayList<Report> list = new ReportService().selectCommentList(pi);
