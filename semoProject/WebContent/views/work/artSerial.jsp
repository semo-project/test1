...
<body>
 ...
 <div class="lzTab-hor" role="tablist" data-ga-event-category="연재_UI_종류" style="display: inline-flex;">
      ...
      <div class="lzTab" role="tablist" data-ga-event-category="연재_UI_요일">
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-1" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_액션">액션</button>
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-2" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_판타지">판타지</button>
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-3" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_개그">개그</button>
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-4" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_로맨스">로맨스</button>
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-5" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_미스터리">미스터리</button>
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-6" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_일상">일상</button>
        <button type="button" class="btn btn-dark"  data-tab="1" role="tab" aria-controls="art-7" data-go-on="click" data-ga-event-action="click_tab" data-ga-event-label="탭_기타">기타</button>
