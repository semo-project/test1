...
#searchform{
    ...
    #userId, #userPwd{
      ...
      border-left: 0px;
      border-right: 0px;
      border-bottom: 1px rgb(17, 17, 17);
    }
    ...
    .lgBtn-major[disabled], .lgBtn-major:disabled{
      background: #dbdee3;
    }
    .lgBtn-major{
      background: #eb0026;
    ...
    .account_btn-naver{
      ...
      background-image: url(//cdn.lezhin.com/files/assets/img/icon-naver.svg);
    ...
    .account_btn-kakao{
      ...
      /* background-image: url(//cdn.lezhin.com/files/assets/img/icon-facebook.svg); */
   ...
   <div>
	...
	<form class="form-horizontal" role="form" method="post" action="javascript:alert( 'success!' );">
        <div class="form-group">
            <label for="provision" class="col-lg-2 control-label" style="text-align: center;">회원가입약관</label>
            <div class="col-lg-10" id="provision">
                <textarea class="form-control" rows="8" style="resize:none" style="text-align: left;">
여러분을 환영합니다.
...
적용 일자: 2018년 5월 1일
        ...
        <div class="form-group">
            <label for="memberInfo" class="col-lg-2 control-label" style="text-align: center;">개인정보취급방침</label>
...
<script>
	$(function(){
		$(":radio").change(function(){
			if($(":radio").eq(0).prop("checked") && $(":radio").eq(2).prop("checked")){
				console.log("둘다 동의합니다.");
				$("#member_join2").attr('href', 'MemberEnroll.me');
			}else{
				console.log("둘다 동의합니다. 아님");
				$("#member_join2").removeAttr('href');
			}
